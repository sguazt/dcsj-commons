...
/**
 * A processor for the <em>Experimental</em> annotation.
 *
 * This annotation processor follows the new JDK 6 annotation (JSR269) API.
 *
 * @author <a href="mailto:marco.guazzone@gmail.com">Marco Guazzone</a>
 */
@SupportedAnnotationTypes( "it.unipmn.di.dcs.common.annotation.Experimental" )
public class ExperimentalAnnotationProcessor extends AbstractProcessor
{
	...
	public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv)
	{
		if (!roundEnv.processingOver())
		{
			...
			{
				Experimental exp = el.getAnnotation( Experimental.class );
				if ( exp != null )
				{
					this.printMessage( exp, el );
				}
			}
		}
	...
	private void printMessage(Experimental exp, Element el)
	{

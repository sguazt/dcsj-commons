...
/**
 * Binary textual operator.
 *
 * @author <a href="mailto:marco.guazzone@gmail.com">Marco Guazzone</a>
 */
public class BinaryTextOp extends AbstractTextOp
{
	/** A constructor. */
	public BinaryTextOp(String symbol, String name)
	{
		super( symbol, name, "" );
	}

	/** A constructor. */
	public BinaryTextOp(String symbol, String name, String descr)
	{
		super( symbol, name, descr );
	}

	@Override
	public TextOpType getType()
	{
		return TextOpType.BINARY;
	}
}

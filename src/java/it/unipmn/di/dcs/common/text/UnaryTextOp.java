...
/**
 * Unary textual operator.
 *
 * @author <a href="mailto:marco.guazzone@gmail.com">Marco Guazzone</a>
 */
public class UnaryTextOp extends AbstractTextOp
{
	/** A constructor. */
	public UnaryTextOp(String symbol, String name)
	{
		super( symbol, name, "" );
	}

	/** A constructor. */
	public UnaryTextOp(String symbol, String name, String descr)
	{

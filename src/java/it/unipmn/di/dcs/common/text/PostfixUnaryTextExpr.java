...
/**
 * Class for postfix unary operators.
 *
 * @author <a href="mailto:marco.guazzone@gmail.com">Marco Guazzone</a>
 */
public class PostfixUnaryTextExpr extends AbstractUnaryTextExpr
{
	/** A constructor. */
	protected PostfixUnaryTextExpr()
	{
		super();
	}

	/** A constructor. */
	public PostfixUnaryTextExpr(ITextExpr expr, UnaryTextOp op)
	{
		super( op, expr );
	}

 ...
 */
public interface IHostProberStats
{
	IHostPingerStats getPingStats();

	Collection<IInetServiceStats> getInetServicesStats();

	IInetServiceStats getInetServiceStats(InetProtocol proto, int port);
}

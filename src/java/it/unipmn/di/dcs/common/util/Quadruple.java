...
/**
 * Store a quadruple of objects, possibly of different types.
 *
 * @author <a href="mailto:marco.guazzone@gmail.com">Marco Guazzone</a>
 */
public class Quadruple<V1,V2,V3,V4>
{
	private V1 v1; /** The first element of the quadruple */
	private V2 v2; /** The second element of the quadruple */
	private V3 v3; /** The third element of the quadruple */
	private V4 v4; /** The fourth element of the quadruple */
